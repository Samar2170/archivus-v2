...
import { Bars3Icon, BellIcon, XMarkIcon, HomeIcon, ListBulletIcon, MagnifyingGlassIcon } from '@heroicons/react/24/outline'
              ...
              <div className="border-t border-indigo-700 pt-4 pb-3">
                <div className="flex items-center px-5">
                  ...
                  <div className="ml-3">
                    ...
                    <div className="text-sm font-medium text-indigo-300">{user}</div>
                  </div>
                  <button
                    type="button"
